...
public class ImagemValidator {
	...
	public boolean tratarImagem(MultipartFile imagem, Usuario usuario,
		...
		ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(imagem.getBytes());
		String mime = URLConnection.guessContentTypeFromStream(byteArrayInputStream);
		if(mime == null) {
			return false;
		}
